...
| Nx workspace migration | 开发中 | 只改 workspace tooling 和 project metadata，不移动业务目录 | `docs/modules/nx-workspace.md` |
...
- `libs/contracts` 和 `libs/domain` 是后续独立模块，不能混入 Nx workspace migration。
